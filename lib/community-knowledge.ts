...
export function communityKnowledge(): KnowledgeDoc[] {
  ...
  return [
    ...
    },
    {
      ...
      answer: "Há seis áreas de estudo: **engenharia de software**, **inteligência artificial**, **robótica**, **DevOps**, **automação** e **empreendedorismo**. Cada uma com fundamentos sólidos e prática.",
      related: ["software", "inteligencia", "robotica", "devops", "automacao", "empreendedorismo", "tecnologias"],
    },
    {
      id: "software",
      title: "Engenharia de software",
      keywords: ["software", "programacao", "codigo", "desenvolvimento", "arquitetura", "open source", "engenharia"],
    ...
    },
    {
      id: "robotica",
      title: "Robótica",
      keywords: ["robotica", "robo", "eletronica", "prototipo", "sensor", "arduino", "raspberry", "circuito"],
      answer: "A trilha de robótica é sobre ideias que ganham movimento: conectar programação, eletrônica e criatividade para interagir com o mundo real. Os temas passam por eletrônica, sensores e prototipagem. Um primeiro caminho: conhecer circuitos, sensores e microcontroladores em um simulador, programar um protótipo que responda a um sensor e registrar o circuito e o código para outras pessoas reproduzirem.",
      related: ["areas", "tecnologias", "como-comecar"],
    },
    {
      id: "devops",
      title: "DevOps",
      keywords: ["devops", "ci", "cd", "pipeline", "infraestrutura", "observabilidade", "container", "entrega", "deploy"],
      answer: "A trilha de DevOps é sobre o caminho do código até quem usa: previsibilidade, colaboração e responsabilidade na entrega. Os temas passam por CI/CD, infraestrutura e observabilidade. Um primeiro caminho: montar um fluxo simples de build e teste, empacotar um projeto em um ambiente reproduzível e documentar o processo para alguém revisar.",
      related: ["areas", "tecnologias", "automacao", "como-comecar"],
    },
    {
      id: "automacao",
      title: "Automação",
      keywords: ["automacao", "automatizar", "script", "scripts", "fluxo", "fluxos", "integracao", "rpa", "tarefa repetitiva"],
      answer: "A trilha de automação é menos repetição e mais intenção: identificar tarefas manuais e transformá-las em fluxos que poupam tempo e reduzem erro. Os temas passam por scripts, fluxos e integrações. Um primeiro caminho: listar uma tarefa repetitiva, escrever um script ou fluxo que a execute do começo ao fim e compartilhar o que você ganhou com isso.",
      related: ["areas", "devops", "tecnologias", "como-comecar"],
    },
    {
      id: "empreendedorismo",
      title: "Empreendedorismo",
      keywords: ["empreendedorismo", "empreender", "negocio", "startup", "produto", "validacao", "iniciativa", "comunidade"],
      answer: "A trilha de empreendedorismo é sobre ideias que encontram gente e território: validar problemas, construir em público e transformar conhecimento em iniciativas que servem a região. Os temas passam por validação, produto e comunidade. Um primeiro caminho: escolher um problema real, conversar com três pessoas afetadas e esboçar uma solução mínima para testar.",
      related: ["areas", "como-comecar", "participar"],
    },
    {
      id: "parceiras",
    ...
    },
    {
      ...
      answer: "Escolha uma área e siga um primeiro desafio no seu ritmo. Em software: lógica, Git e uma aplicação para a comunidade. Em inteligência artificial: Python, um modelo simples e o que você aprendeu. Em robótica: sensores e um protótipo registrado. Em DevOps: um fluxo de build e um ambiente reproduzível. Em automação: uma tarefa repetitiva virando script. Em empreendedorismo: um problema real, três conversas e uma solução mínima. Iniciante, estudante ou profissional: existe espaço para você.",
      related: ["software", "inteligencia", "robotica", "devops", "automacao", "empreendedorismo", "participar"],
    },
    {
      id: "quem",
    ...
    },
    {
      ...
      answer: "Ao redor de quem desenvolve, a comunidade explora TypeScript, React, Node.js, Ruby, Rails, Python, PyTorch, Arduino, Raspberry Pi, Git, GitHub e Docker. Elas atravessam software, inteligência artificial, robótica, DevOps, automação, colaboração e infraestrutura. A ideia é colocar você no centro e as possibilidades ao redor.",
      related: ["areas", "software", "inteligencia", "robotica", "devops", "automacao"],
    },
    {
      id: "kit",
