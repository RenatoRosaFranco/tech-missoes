...
const PageMotion = dynamic(() => import("./page-motion").then(mod => ({ default: mod.PageMotion })), { ssr: false });
const Technologies = dynamic(() => import("./technologies").then(mod => ({ default: mod.Technologies })));
const Partners = dynamic(() => import("./partners").then(mod => ({ default: mod.Partners })));
const CommunityChat = dynamic(() => import("./community-chat").then(mod => ({ default: mod.CommunityChat })), { ssr: false });
...
export function HomePage() {
  ...
  return <>
    ...
    <main id="conteudo">
      ...
      {showPartnersSection ? <Partners /> : null}
