...
export function StarterKit() {
  return <section className="starter-kit" id="starter-kit" aria-labelledby="kit-title">
    <div className="container">
      <div className="section-heading kit-heading"><div><span className="eyebrow">08 / LEVE A COMUNIDADE COM VOCÊ</span><h2 id="kit-title">Seu próximo capítulo.<br /><em><TypedLine inView strings={kitTyped} /></em></h2></div><p>Na mesa de estudos, nas novas ideias e no dia a dia.<br />Três itens para quem aprende e constrói em comunidade.</p></div>
